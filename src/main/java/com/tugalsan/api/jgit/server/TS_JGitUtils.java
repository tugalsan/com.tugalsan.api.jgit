...
public class TS_JGitUtils {
    ...
    public static TGS_UnionExcuseVoid repoCreate(Path at, TGS_RunnableType1<Git> git) {
    ...
    public static TGS_UnionExcuseVoid repoClone(TGS_Url from, Path to, TGS_RunnableType1<Git> git) {
    ...
    public static TGS_UnionExcuseVoid repoOpen(Path at, TGS_RunnableType1<Git> git) {
